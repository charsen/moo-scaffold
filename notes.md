...
- model-has-operator-trait stub 已改经 Mooeen\Scaffold\Contracts\OperatorResolver 取操作人 ID（B-01 方案 B，2026-07-16）；默认 auth()->id() 未登录 null，host bind 覆盖。stub 属「缺则生成、不覆盖」，存量副本不自愈。
