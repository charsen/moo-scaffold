...
it('moo:controller:Controller/Request/Trait 落包、BaseActionTrait 恒指 host、路由插包 admin.php', function () {
    ...
    // BaseActionTrait 指 host(App\Admin\...),controller trait 指包
    expect($ctlTxt)->toContain('Admin\\Controllers\\Traits\\BaseActionTrait');
