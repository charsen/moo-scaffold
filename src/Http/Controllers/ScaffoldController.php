...
class ScaffoldController extends Controller
{
    ...
    private function getDashboardStats(array $validated, array $apps): array
    {
        ...
        $publishHistory       = $this->publishHistoryService->getApiPublishHistory($apps);
        $publishHistoryGroups = $this->publishHistoryService->groupApiPublishHistory($publishHistory);
        $paginatedHistory     = $this->publishHistoryService->paginatePublishHistoryGroup($validated, $publishHistoryGroups);
