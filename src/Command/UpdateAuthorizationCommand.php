...
class UpdateAuthorizationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        // 过滤出制定 app 的路由目录
        $this->filter_folder = ucfirst(rtrim($apps[$this->app]['path'], '/'));
        ...
        $result = (new UpdateAuthorizationGenerator($this, $this->filesystem, $this->utility))->start($this->app, $routes);
    ...
    protected function getRoutes(): array
    {
        ...
        $routes = $this->sortRoutes('action', $routes);
